...
plot_crossmethod_concordance <- function(res, ncluster) {
  ...
  # TY2019: edit for compatibility between tidytree_0.1.9 and ggtree_1.12.x
  phylo_object <- as.phylo(hcl_average)
  tibble_object <- as_tibble(phylo_object$root.edge)
  ggt <- ggtree(tibble_object)
  ...
  # print("Gonna do ann.tree <- plot_grid...")
